...
import CustomLoader from '../../../common/customComponents/CustomLoader';
...
import isEmptyOrWhiteSpace from '../../../common/utils/isEmptyOrWhiteSpace';
...
const Blog = () => {
    ...
    const { isLoading, isSuccess, isError, data, error } = useGetBlogsQuery();
    ...
    useEffect(() => {
        const dataError = postBlogProps.isError;
        const dataSuccess = postBlogProps.isSuccess;
        const errorDescription = postBlogProps.error?.data.description;
        const successDescription = postBlogProps.data?.description;
    ...
    }, [postBlogProps.isError, postBlogProps.isSuccess]);

    useEffect(() => {
        const dataError = updateBlogProps.isError;
        const dataSuccess = updateBlogProps.isSuccess;
        const errorDescription = updateBlogProps.error?.data.description;
        const successDescription = updateBlogProps.data?.description;
    ...
    }, [updateBlogProps.isError, updateBlogProps.isSuccess]);

    useEffect(() => {
        const dataError = deleteBlogProps.isError;
        const dataSuccess = deleteBlogProps.isSuccess;
        const errorDescription = deleteBlogProps.error?.data.description;
        const successDescription = deleteBlogProps.data?.description;
    ...
    }, [deleteBlogProps.isError, deleteBlogProps.isSuccess]);
